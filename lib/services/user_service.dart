...
class _UserFormDialogState extends State<UserFormDialog> {
  ...
  @override
  void dispose() {
    _email.dispose(); _name.dispose(); _password.dispose();
    super.dispose();
  }
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                // Si QUIERES permitir admin, descomenta:
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Password temporal (opcional)'),
              obscureText: true,
            ),
          ],
        ),
          ...
          onPressed: _busy ? null : () async {
            ...
            try {
              final res = await AdminFunctionsService().createUser(
                ...
                role: _role,
                tempPassword: _password.text.trim().isEmpty ? null : _password.text.trim(),
              );
              if (mounted) {
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Creado: ${res["email"]} / pass: ${res["tempPassword"]}')),
                );
              }
            } catch (e) {
              if (mounted) {
